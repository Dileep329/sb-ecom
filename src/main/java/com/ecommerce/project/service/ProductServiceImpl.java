...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductResponse getAllProducts(Integer pageNumber,Integer pageSize,String sortBy,String sortOrder) {
        ...
        List<Product> savedProduct=productsPage.getContent();
        List<ProductDTO> productDTOS = savedProduct.stream().map(product -> modelMapper.map(product, ProductDTO.class))
                .toList();
        if(savedProduct.isEmpty())
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "No product exists");
