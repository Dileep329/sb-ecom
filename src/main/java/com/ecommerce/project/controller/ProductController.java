...
public class ProductController {
    ...
    public ResponseEntity<ProductDTO> addProduct(@Valid @RequestBody ProductDTO productDTO,
       ...
       ProductDTO addedDTO=productService.addProduct(categoryId,productDTO);
    ...
    public ResponseEntity<ProductDTO> deleteProduct(@PathVariable Long productId){
        ProductDTO deltetedProductDTO=productService.deleteProductByProductId(productId);
        return new ResponseEntity<>(deltetedProductDTO,HttpStatus.OK);
    }
